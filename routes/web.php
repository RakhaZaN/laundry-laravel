...
Route::group([
    ...
    Route::resource('/pesanan', PesananController::class)->name('as', 'pesanan')->except(['index', 'show']);
    Route::put('/pesanan/{transaksi}/approve', [PesananController::class, 'approveTransaksi'])->name('pesanan.approve');
    Route::put('/pesanan/{pesanan}/cancel', [PesananController::class, 'cancelPesanan'])->name('pesanan.cancel');
    Route::put('/pesanan/{pesanan}/status', [PesananController::class, 'statusPesanan'])->name('pesanan.status');
